...
public class GeekilyPaginator {
    ...
    private GeekilyPaginator(Builder builder) {
	...
	public GeekilyMap getPaginationMap() {
		GeekilyMap paginationMap = new GeekilyMap();
    ...
    public static class Builder {
        ...
        public GeekilyPaginator build() {
            return new GeekilyPaginator(this);
        }
    }
