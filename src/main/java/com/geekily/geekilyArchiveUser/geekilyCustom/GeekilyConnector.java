package com.geekily.geekilyArchiveUser.geekilyCustom;
...
public class GeekilyConnector {
    ...
    private GeekilyConnector(Builder builder) {
    ...
    public GeekilyMap sendMultiPartFile(String partName) throws Exception {
        ...
        return new ObjectMapper().readValue(responseEntity.getBody(), GeekilyMap.class); // json into map
    }
    ...
    public static class Builder {
        ...
        public GeekilyConnector build() {
            return new GeekilyConnector(this);
        }
    }
}
